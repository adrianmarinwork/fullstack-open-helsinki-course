...
describe('total likes tests', function () {
  ...
  test('of a bigger list is calculated right', function () {
    ...
    const sumAllLikes = blogs.reduce(
      (previous, current) => previous + current.likes,
      0
    );
    assert.strictEqual(result, sumAllLikes);
  });
});

describe('favorite tests', function () {
...
describe('mostBlogs tests', function () {
  test('of a bigger list is calculated right', function () {
...
describe('mostLikes tests', function () {
  test('of a bigger list is calculated right', function () {
